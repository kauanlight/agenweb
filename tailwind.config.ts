    ...
    extend: {
      ...
      colors: {
        ...
        boxShadow: {
          ...
          'glow': '0 0 15px rgba(74, 0, 224, 0.3)'
        },
        borderRadius: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(90deg, #4A00E0 0%, #8E2DE2 100%)',
        'gradient-secondary': 'linear-gradient(135deg, #8E2DE2 0%, #4A00E0 100%)',
        'grid-pattern': 'linear-gradient(to right, #161616 1px, transparent 1px), linear-gradient(to bottom, #161616 1px, transparent 1px)',
      },
      animation: {
